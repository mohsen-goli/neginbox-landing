  ...
  productCards.forEach((card) => {
    ...
    card.addEventListener("click", () => {
      ...
      if (modalImage && img) {
        ...
        modalImage.alt = title ? title.textContent : "╪ز╪«╪ز ╪«┘ê╪د╪ذ ┘┌»█î┘ظî╪ذ╪د┌ر╪│";
      }
      ...
      if (modalWhatsapp && title) {
        ...
        const msg = `╪│┘╪د┘à╪î ╪»╪▒╪ذ╪د╪▒┘ç ${prodName} ┘┌»█î┘ظî╪ذ╪د┌ر╪│ ┘à╪د█î┘ ╪ذ┘ç ╪»╪▒█î╪د┘╪ز ┘à╪┤╪د┘ê╪▒┘ç ┘ê ╪د╪│╪ز╪╣┘╪د┘à ┘é█î┘à╪ز ┘ç╪│╪ز┘à.`;
